...
COLOR_CASE = 1 # options are: 0 red, 1 pink, 2 blue, 3 green
...
# BASE_PATH = os.path.join(drive1, "\\", "Users", "michalro", "Leaf_detection", "3d_images", "full_sessions", "2024-05-29-11-18-42")
# BASE_PATH = os.path.join(drive1, "\\", "Users", "michalro", "Leaf_detection", "3d_images", "full_sessions", "2024-06-09-12-12-23")
BASE_PATH = os.path.join(drive1, "\\", "Users", "michalro", "Leaf_detection", "3d_images", "full_sessions", "2024-06-25-14-58-28")
